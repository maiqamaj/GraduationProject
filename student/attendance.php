...
$sql=mysqli_query($con,"SELECT DISTINCT subject FROM `attendance` where class='".$class['section_id']."' ");
while(  $row=mysqli_fetch_array($sql))
{
  ...
  ?>
    ...
    align-content: space-between;  width:170px; height: 200px; ">
                <a href= "showattendance.php?id=<?php echo $subject['id']?>"  style="text-decoration:none;" >
                <?php  
