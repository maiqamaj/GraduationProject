...
$query=mysqli_query($con,"SELECT * FROM student WHERE id='$regno' and password='$password'");
$num=mysqli_fetch_array($query);
if($num>0)
{
$extra="home.php";//
$_SESSION['login']=$_POST['regno'];
$_SESSION['id']=$_POST['regno'];
		...
		<div class="container h-100">
			<div class="row justify-content-md-center h-100">
				<div class="card-wrapper">
					...
					<div class="card fat" >
                  	...
                  	<h4 class="card-title"  style="text-align:center;">تسجيل الدخول الطالب</h4>
            ...
            <form name="admin" method="post" >
                    ...
                    <div class="form-group">
									<label for="regno"  style="text-align:right;">اسم المستخدم</label>
                      ...
                      <br>  
					  <p style="text-align: right;">  هل نسيت كلمة السر؟  <a href ="forgetBass.php">انقر هنا</a></p>
					  <hr />
