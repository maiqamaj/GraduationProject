...
if(isset($_POST['submit']))
{
    ...
    if($vir){
$ret=mysqli_query($con,"update student set phone='$phone',updationDate='$currentTime' where id='$s'");
if($ret)
{
...
<head>
    ...
    <title>الطالب|تعديل الهاتف </title>
...
<?php include('includes/header.php');?>
 <a href="info_student.php"> <b> <button  style="position: absolute; 
  left: 50px; top:30px; color:#6F479F; border: none; background-color:#e8e8e8;">العوده</button></b></a>
   ...
   <div class="col-md-12">
                         <h1  style="color:#6F479F; background-color:#fff; font-size:20px; font-weight: bold;">تعديل هاتف الطالب</h1>
                         <hr class="my-5">
