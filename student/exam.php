                                    ...
                                    <tbody>
                                        <tr>
                                             ...
                                             <th style="text-align:center"> العلامة الكلية</th>
                                              <th style="text-align:center">بداية الاختبار</th>
                                                 <th style="text-align:center">نهاية الاختبار</th>
                                     ...
                                     <?php     $cnt=1;   
                                       $sql=mysqli_query($con,"SELECT * FROM `student` where id='".$_SESSION['login']."' ");
                                         ...
                                         $sql=mysqli_query($con,"SELECT * FROM `exam_tbl` where class_id='".$c['section_id']."' AND sub_id='".$class['id']."' ");
  ...
  $teacher= mysqli_fetch_array($sec);
   ...
   $X1=substr($row['end_time'],10,10);          
                                        ...
                                        <tr>
                                         ...
                                         <td style="text-align:center"><?php echo htmlentities($row['ex_title']); ?></td>
                                         <td style="text-align:center"><?php echo htmlentities($row['ex_questlimit_display']); ?></td>
                                         <td style="text-align:center"><?php echo htmlentities($row['ex_mark']); ?></td>
                                         ...
                                         <td style="text-align:center"><?php echo 'التاريخ : ',$X,'</br>','الساعة :',$X1; ?></td>     
                                                 ...
                                                 <td style="text-align:center"><?php echo htmlentities($row['ex_description']);?></td>
                                              <td style="text-align:center">
                                                  
                                                    <a href="time-exam.php?id=<?php echo $row['exam_id']?>">
                                                <button class="btn btn-primary" style="background-color:#008000;"> بدء الاختبار</button> </a>  
