...
if(isset($_GET['del']))
      {$exam_id=$_SESSION['exam_id'];
             $de="DELETE FROM exam_question_tbl where eqt_id = '".$_GET['id']."'";
...
اضافة سؤال                       </div>
    ...
    <div class="form-group">
                ...
                <input type="number" name="mark" id="" class="form-control" placeholder="علامة السؤال" autocomplete="off" required="">
            </div>
    <div  class="form-group" align="right" >
       <label>نص السؤال</label>
            <input type="hidden" name="examId" value="<?php echo $exId; ?>">
            <input type="" name="question" id="course_name" class="form-control" placeholder="ادخل السؤال" autocomplete="off" required="">
          ...
          <fieldset>
            ...
            <div class="form-group">
                ...
                <input type="" name="choice_A" id="choice_A" class="form-control" placeholder="الخيار الاول" autocomplete="off" required="">
            </div>

            <div class="form-group">
                <label> الخيار الثاني</label>
                <input type="" name="choice_B" id="choice_B" class="form-control" placeholder="الخيار الثاني" autocomplete="off" required="">
            </div>

            <div class="form-group">
                <label>الخيار الثالث</label>
                <input type="" name="choice_C" id="choice_C" class="form-control" placeholder="الخيار الثالث" autocomplete="off" required="">
            </div>

            <div class="form-group">
                <label>الخيار الرابع</label>
                <input type="" name="choice_D" id="choice_D" class="form-control" placeholder="الخيار الرابع" autocomplete="off" required="">
            </div>

            <div class="form-group">
                <label>الاجابة الصحيحه</label>
                <input type="" name="correctAnswer" id="" class="form-control" placeholder="الاجابة الصحيحة" autocomplete="off" required="">
            </div>
          </fieldset>
 ...
 <div class="content-wrapper">
  ...
  <a href="addqustion.php?id=<?php echo $row1['eqt_id']?>idexam=<?php echo $_SESSION['exam_id']?>&del=delete" onClick="return confirm('هل أنت متأكد من حذف السؤال')">
