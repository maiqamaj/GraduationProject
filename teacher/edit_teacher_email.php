...
if(isset($_POST['submit']))
{
    ...
    if($vir){
$ret=mysqli_query($con,"update teacher set Email='$Email',updationDate='$currentTime' where id='$s'");
if($ret)
{
...
<head>
    ...
    <title>معلم | تعديل الايميل</title>
...
<a href="info_teacher.php"> <b> <button  style="position: absolute;
  left: 50px; top:30px; color:#6F479F; border: none; background-color:#e8e8e8;">العوده</button></b></a>
   ...
   <div class="col-md-12">
                         <h1  style="color:#6F479F; background-color:#fff; font-size:20px; font-weight: bold;">تعديل ايميل المعلم</h1>
                         <hr class="my-5">
