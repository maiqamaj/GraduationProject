...
{  
    $ID=$_POST['ID'];
    $ID2=$_POST['ID2'];
    $q1 =mysqli_query($con,"SELECT * FROM teacher WHERE id = '$ID' AND identity_number = '$ID2'");
...
<div style=" background-color:#6F479F ; color:#fff; font-size:14px ;font-weight: bold;">
      ...
      <a href="login.php"><b><button  style="position: absolute;
...
<?php } ?>
    ...
    <div  class="form-group" align="right" >
          ...
          <div class="form-group">
            ...
            <input type="number" name="ID" id="" class="form-control" placeholder="الرقم التعريفي " required="" >
          </div>
          <div class="form-group">
            <label>  ادخل الرقم الوطني </label>
            <input type="number" name="ID2" id="" class="form-control" placeholder=" الرقم الوطني" maxlength='10' required="">
          </div>
