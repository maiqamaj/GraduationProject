...
<a href="showResultExam.php?id=<?php  $id =$_POST['examID']; echo $id;?>">
<button class="btn btn-primary" style="position: absolute;
  left: 50px; top:30px; color:#6F479F; border: none; background-color:#e8e8e8;"> العوده</button> </a> 
      <!--------------------------------------------------------------------------------------->
 <!-- MENU SECTION END-->
...
?>
 ...
 <div> 
         <?php } echo "<p style='background:#6F479F; color:#fff;  text-align:center;'> علامته الكلية هي  $marks من $markful"; } }
