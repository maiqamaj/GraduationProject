...
<?php include('includes/menubar.php');?>
     ...
     <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1  style="color:#6F479F; background-color:#fff; font-size:20px; font-weight: bold;">اضافة دروس تقوية للطالب  </h1>
                           <hr class="my-5">
                    </div>
                </div>
		...
		<div class="col-md-12">
			<div class="col-md-4" style="word-wrap:break-word;">
				...
				<br > <br>
				<a href="save_video.php?delete=<?php echo $fetch ['video_id'] ?> &del=delete" onClick="return confirm('هل أنت متأكد أنك تريد الحذف؟')">
			...
			<form action="save_video.php" method="POST" enctype="multipart/form-data">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-danger" data-dismiss="modal" style="background-color:#DC143C"><span class="glyphicon glyphicon-remove"></span> Close</button>
